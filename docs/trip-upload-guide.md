...
Use this when you have a folder of 5-10 photos and want the Traveler page to pick them up without hand-creating every file.
...
The safe remote version should be a small authenticated backend, not browser-only JavaScript:
